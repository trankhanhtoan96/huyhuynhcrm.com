<?php
/*
Template Name: Sidebar Grid Blog
*/
get_header();
...
<section id="primary" class="container main_content_area grid_main_content_container">
			<h4 class="page-title screen-reader-text"><?php  printf( esc_html__( '%1$s Articles.', 'alia' ), get_bloginfo( 'name' ) );; ?></h4>
			<?php

			// set layout settings
			set_query_var('custom_blog_layout', 'gridsidebar');
