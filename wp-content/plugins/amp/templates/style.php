...
if (function_exists('alia_option')) {
	$link_color              = alia_option('alia_main_color', '#ff374a');
}else{
...
blockquote {
	border-left: 5px solid <?php echo sanitize_hex_color( $link_color ); ?>;
	font-weight: bold;
	font-style: italic;
	padding: 2px 16px;
	font-weight: bold;
...
.amp-wp-header div, .amp-wp-footer div {
	max-width: calc(640px - 32px);
}

html[dir="rtl"] blockquote {
	border-left: none;
	border-right: 5px solid <?php echo sanitize_hex_color( $link_color ); ?>;
}
...
html[dir="rtl"] .amp-wp-article-header .amp-wp-meta:last-of-type {
	text-align: left;
}

html[dir="rtl"] .amp-wp-article-header .amp-wp-meta:first-of-type {
	text-align: right;
}

html[dir="rtl"] .amp-wp-article-content ul,
html[dir="rtl"] .amp-wp-article-content ol {
	margin-right: 1em;
	margin-left: 0;
}

html[dir="rtl"] .amp-wp-article-content amp-img.alignright {
	margin: 0 16px 1em 0;
}

html[dir="rtl"] .amp-wp-article-content amp-img.alignleft {
	margin: 0 0 1em 16px;
}

html[dir="rtl"] .wp-caption.alignleft {
	margin-left: 16px;
	margin-right 0;
}

html[dir="rtl"] .wp-caption.alignright {
	margin-right: 16px;
	margin-left: 0;
}

html[dir="rtl"] .amp-wp-header .amp-wp-site-icon {
	/** site icon is 32px **/
	background-color: <?php echo sanitize_hex_color( $header_color ); ?>;
	border: 1px solid <?php echo sanitize_hex_color( $header_color ); ?>;
	border-radius: 50%;
...
html[dir="rtl"] .amp-wp-byline amp-img {
	border: none;
	border-radius: 50%;
	position: relative;
	margin-left: 6px;
...
.amp_logo_dot {
	background-color: <?php echo sanitize_hex_color( $link_color ); ?>;
	font-size: 27px;
	display: inline-block;
	width: 5px;
	height: 5px;
